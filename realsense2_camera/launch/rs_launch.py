...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'depth_module.infra_profile',   'default': '848,480,60', 'description': 'infra streams (0/1/2) profile'},
                           {'name': 'depth_module.infra_format',    'default': 'RGB8', 'description': 'infra0 stream format'},
                           {'name': 'depth_module.infra1_format',   'default': 'Y8', 'description': 'infra1 stream format'},
                           {'name': 'depth_module.infra2_format',   'default': 'Y8', 'description': 'infra2 stream format'},
                           {'name': ' infra1_module.profile',       'default': '848,480,30', 'description': 'infra1 stream profile'},
                           {'name': ' infra2_module.profile',       'default': '848,480,30', 'description': 'infra1 stream profile'},
                           {'name': 'infra_module.auto_exposure',   'default': 'false', 'description': 'enable/disable auto exposure for infra image'},
                           {'name': 'infra_module.exposure',        'default': '10000', 'description': 'infra module manual exposure value'},
                           {'name': 'infra1_module.auto_exposure',  'default': 'false', 'description': 'enable/disable auto exposure for infra1 image'},
                           {'name': 'infra1_module.exposure',       'default': '10000', 'description': 'infra1 module manual exposure value'},
                           {'name': 'infra2_module.auto_exposure',  'default': 'false', 'description': 'enable/disable auto exposure for infra2 image'},
                           {'name': 'infra2_module.exposure',       'default': '10000', 'description': 'infra2 module manual exposure value'},

                           {'name': 'depth_module.laser_power',     'default': '0.0', 'description': 'enable laser stream'},

                           {'name': 'depth_module.exposure',        'default': '10000', 'description': 'Depth module manual exposure value'},
                           ...
                           {'name': 'depth_module.exposure.1',      'default': '10000', 'description': 'Depth module first exposure value. Used for hdr_merge filter'},
