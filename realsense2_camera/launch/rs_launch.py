...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'depth_module.infra_profile',   'default': '848,480,90', 'description': 'infra streams (0/1/2) profile'},
                           ...
                           {'name': 'depth_module.exposure.1',      'default': '3000', 'description': 'Depth module first exposure value. Used for hdr_merge filter'},
